...
{ 
    ...
    if (smoking_detected) {
        std::cout << "smoking detected" << std::endl;
    }
...
int main(int argc, char** argv)
{
    ...
    if(parser.has("fire_smoke"))
    {
        ...
        is_save = true;
        param.save_path = "/home/jetson/dxh/TensorRT-Alpha-main/yolov8v1.0q/fire_result/";
        sample::gLogInfo << "save_path = " << param.save_path << std::endl;
    }
    if(parser.has("smoking"))
    {
        ...
        is_save = true;
        param.save_path = "/home/jetson/dxh/TensorRT-Alpha-main/yolov8v1.0q/smoking_result/";
        sample::gLogInfo << "save_path = " << param.save_path << std::endl;
    }
